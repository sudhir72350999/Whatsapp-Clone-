...
import com.sudhirtheindian4.whatsappnewchattingapp.databinding.ItemStatusBinding;
...
public class TopStatusAdapter extends RecyclerView.Adapter<TopStatusAdapter.TopStatusViewHolder> {
    ...
    public  TopStatusAdapter(Context context, ArrayList<UserStatus> userStatus){
 ...
 // for last image show in status
 Status lastStatus = userStatus.getStatuses().get(userStatus.getStatuses().size()-1);
        Glide.with(context).load(lastStatus.getImageUrl()).into(holder.binding.image);
        // for last image show in status

        // for status portion count
holder.binding.circularStatusView.setPortionsCount(userStatus.getStatuses().size());
        ...
        holder.binding.circularStatusView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new StoryView.Builder(((MainActivity)context).getSupportFragmentManager()) // tycasting of mainactivity
